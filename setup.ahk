	...
	if (dir = "")
		{
			...
			FileCreateShortcut, %A_ScriptDir%\main.exe, %A_Desktop%\Erlkönig.lnk , , , , %A_ScriptDir%\core\icons\ampersand.ico
	...
	else
		{
			...
			FileCreateShortcut, %A_ScriptDir%\main.ahk, %A_Desktop%\Erlkönig.lnk , , , , %A_ScriptDir%\core\icons\ampersand.ico
